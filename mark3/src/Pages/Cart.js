                ...
                <table className='table' key={index}>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select name='size' className="form-control" onChange={(e) => handleSize(e, item.id)}>
                                    ...
                                    <option value="XL" selected={item.size === 'XL'}>XL</option>
                                </select>
